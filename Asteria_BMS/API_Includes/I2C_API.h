...
extern volatile uint8_t GPS_Data_Request,Flight_Status_Request,GPS_Data_Received,Flight_Stat_Received,SMBUS_Request;
extern volatile uint32_t SMBUS_Request_Start_Time;
