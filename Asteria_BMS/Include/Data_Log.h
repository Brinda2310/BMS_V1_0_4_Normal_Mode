...
#define DIRECTORY_NAME_START_ADDRESS				ADDR_FLASH_PAGE_120
#define DIRECTORY_NAME_END_ADDRESS					ADDR_FLASH_PAGE_120+8
...
uint8_t Directory_Name[] = "_1/";
uint8_t File_Name[] = "Log_16_02_2017.txt";
